                            ...
                            <div class="widget-content">
                                <form class="row" id="form-data">
                                    ...
                                    <div class="mb-3 col-lg-6">
                                        ...
                                        <input type="text" class="form-control" placeholder="Whatsapp No 1 " id="whatsapp_no_1" name="whatsapp_no_1">
                                    </div>
                                    <div class="mb-3 col-lg-6">
                                        <label class="form-label">Whatsapp No 2</label>
                                        <input type="text" class="form-control" placeholder="Whatsapp No 2" id="whatsapp_no_2" name="whatsapp_no_2">
                                    </div>
